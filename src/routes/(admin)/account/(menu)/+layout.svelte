<script lang="ts">
  ...
  function handleLanguageChange(lang: "en" | "tr"): void {
    setLanguage(lang)
  }
  ...
  <div class="drawer-side">
    ...
    >
      <li>
        ...
        >
          <a href="/">
            <img src="/logo-landscape.png" alt="ÖğrenAI" class="h-16" />
          </a>
      ...
      <li>
        <a
          href="/account/my-decks"
          class={adminSection === "my-decks" ? "active" : ""}
          onclick={closeDrawer}
          rel="external"
        >
          <svg
      ...
      <!-- <li>
        <a
          ...
          class={adminSection === "profile" ? "active" : ""}
          onclick={closeDrawer}
        >
          <svg
            xmlns="http://www.w3.org/2000/svg"
      ...
      <li>
        ...
        >
          ...
          <div class="join">
            <button
              class={`join-item btn btn-sm ${currentLang === "en" ? "btn-primary" : "btn-outline"}`}
            ...
            <button
              class={`join-item btn btn-sm ${currentLang === "tr" ? "btn-primary" : "btn-outline"}`}
              onclick={() => handleLanguageChange("tr")}
              aria-label={t.switchToTurkish}
            >
              TR
            </button>
          </div>
      ...
      <li>
        <a href="/account/sign_out" class="text-base font-medium">{t.signOut}</a
        >
      </li>
    </ul>
  </div>
