<script lang="ts">
  ...
  const translations = {
    ...
    tr: {
      ...
      spacedButtonText: "Aralıklı tekrar yöntemiyle öğren",
  ...
  const testimonials = [
    ...
    },
    {
      ...
      testimonial: "The AI quizzes helped me ace my finals!",
      likes: 45,
      when: 2,
    },
    {
      ...
      testimonial: "Best study tool I've ever used",
      likes: 28,
      when: 5,
    },
    {
      ...
      testimonial: "Makes learning fun and interactive",
      likes: 67,
      when: 8,
    },
    {
      ...
      testimonial: "Perfect for quick revision sessions",
      likes: 33,
      when: 1,
    },
    {
      ...
      testimonial: "Great for learning languages!",
      likes: 89,
      when: 3,
    },
    {
